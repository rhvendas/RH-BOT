...
def banner(console):
    ...
    brand_name =  "ATENCAO ESSA FERRAMENTE SO PODE SER VENDIDA PELO ADM @RH_VENDAS_OFC NUMERO OFICIAL   +5569993571857 SE VOCE ADQUIRIU COM OUTRA PESSOA, VOCE CAIU EM UM GOLPE."
    colors = [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{01}: Aumentar Dinheiro           1.000K'))
print(Colorate.Horizontal(Colors.rainbow, '{02}: Aumentar Moedas            3.500K'))
print(Colorate.Horizontal(Colors.rainbow, '{03}: Rank de Rei                4.000K'))
print(Colorate.Horizontal(Colors.rainbow, '{04}: Alterar ID                 3.500K'))
print(Colorate.Horizontal(Colors.rainbow, '{05}: Alterar Nome               1.00'))
print(Colorate.Horizontal(Colors.rainbow, '{06}: Alterar Nome (Arco-Íris)   1.00'))
print(Colorate.Horizontal(Colors.rainbow, '{07}: Placas de Número           2.000K'))
print(Colorate.Horizontal(Colors.rainbow, '{08}: Excluir Conta              GRATUITO'))
print(Colorate.Horizontal(Colors.rainbow, '{09}: Registrar Conta            GRATUITO'))
print(Colorate.Horizontal(Colors.rainbow, '{10}: Excluir Amigos             5.00'))
...
print(Colorate.Horizontal(Colors.rainbow, '{13}: Desbloquear Sirene de Carros 2.000K'))
...
print(Colorate.Horizontal(Colors.rainbow, '{16}: Desbloquear Desativar Dano 2.000K'))
...
print(Colorate.Horizontal(Colors.rainbow, '{20}: Alterar Vitórias em Corridas 1.000K'))
print(Colorate.Horizontal(Colors.rainbow, '{21}: Alterar Derrotas em Corridas 1.000K'))
